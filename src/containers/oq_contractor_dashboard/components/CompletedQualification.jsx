 ...
 */
class CompletedQualificationEmptyRowsView extends React.Component {
    render() {
        return (<div className="no-records-found-modal">Sorry, no records</div>)
    }
};

class CompletedQualification extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            rows: this.createRows(this.props.completedQualifications),
    ...
    */
    componentWillReceiveProps(newProps) {
        let rows = this.createRows(newProps.completedQualifications),
            isArray = Array.isArray(newProps.completedQualifications),
            isInitial = isArray;
        this.setState({
    ...
    toggle() {
        ...
        this.props.updateState("isCompletedQualificationView");
    }
        ...
        return (
            <div>
                <Modal backdropClassName={this.props.backdropClassName} backdrop={"static"} isOpen={this.state.modal} fade={false} toggle={this.toggle} centered={true} className="custom-modal-grid">
                    <ModalHeader toggle={this.toggle}>Completed Qualification</ModalHeader>
                    <ModalBody>
...
export default withCookies(CompletedQualification);