/* eslint-disable */
/*
* ComingDueQualification.jsx
* Written by Prashanth Ravi (pravi@its-training.com)
* This javascript file will used render Coming due qualifications details on COQ Dashboard
...
/**
 * ComingDueQualificationEmptyRowsView Class defines the React component to render
 * the table components empty rows message if data is empty from API request
 * extending the react-data-grid module.
 */
class ComingDueQualificationEmptyRowsView extends React.Component {
    render() {
        return (<div className="no-records-found-modal">Sorry, no records</div>)
    }
};

class ComingDueQualification extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            rows: this.createRows(this.props.comingDueQualifications),
    ...
    */
    componentWillReceiveProps(newProps) {
        let rows = this.createRows(newProps.comingDueQualifications),
            isArray = Array.isArray(newProps.comingDueQualifications),
            isInitial = isArray;
        this.setState({
    ...
    toggle() {
        ...
        this.props.updateState("isComingDueQualificationView");
    }
    ...
    */
    handleCellClick = (type, args) => {
        ...
        this.refs.comingDueQualificationReactDataGrid.deselect();
    };
                ...
                <Modal backdropClassName={this.props.backdropClassName} backdrop={"static"} isOpen={this.state.modal} fade={false} toggle={this.toggle} centered={true} className="custom-modal-grid">
                    ...
                    <ModalBody>
                        <div className="grid-container">
                            <div className="table">
                                <ReactDataGrid
                                    ref={'comingDueQualificationReactDataGrid'}
...
export default withCookies(ComingDueQualification);