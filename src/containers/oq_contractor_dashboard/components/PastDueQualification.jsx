 ...
 */
class PastDueQualificationEmptyRowsView extends React.Component {
    render() {
...
class PastDueQualification extends PureComponent {
    ...
    */
    handleCellClick = (type, args) => {
        ...
        this.refs.pastDueQualificationReactDataGrid.deselect();
    };
        ...
        return (
            <div>
                <Modal backdropClassName={this.props.backdropClassName} backdrop={"static"} isOpen={this.state.modal} fade={false} toggle={this.toggle} centered={true} className="custom-modal-grid">
                    <ModalHeader toggle={this.toggle}>Past Due Qualifications</ModalHeader>
                    <ModalBody>
                        <div className="grid-container">
                            <div className="table">
                                <ReactDataGrid
                                    ref={'pastDueQualificationReactDataGrid'}
...
export default withCookies(PastDueQualification);