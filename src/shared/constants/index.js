...
export const GET_EMPLOYEE_QUALIFICATION_COLUMNS = ["USER_ID", "COMPANY_ID","EMPLOYEE_NAME","TOTAL_EMPLOYEES","ASSIGNED_QUALIFICATION","COMPLETED_QUALIFICATION","IN_DUE_QUALIFICATION","PAST_DUE_QUALIFICATION","IN_COMPLETE_QUALIFICATION"];
