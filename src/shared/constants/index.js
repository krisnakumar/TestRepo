...
export const GET_QUALIFICATION_COLUMNS = ["USER_ID","EMPLOYEE_NAME","ROLE","TOTAL_EMPLOYEES","ASSIGNED_QUALIFICATION","COMPLETED_QUALIFICATION","IN_DUE_QUALIFICATION","PAST_DUE_QUALIFICATION","IN_COMPLETE_QUALIFICATION"];
export const GET_CONTRACTOR_QUALIFICATION_COLUMNS = ["USER_ID","EMPLOYEE_NAME","TOTAL_EMPLOYEES","ASSIGNED_QUALIFICATION","COMPLETED_QUALIFICATION","IN_DUE_QUALIFICATION","PAST_DUE_QUALIFICATION","IN_COMPLETE_QUALIFICATION"];
export const GET_EMPLOYEE_QUALIFICATION_COLUMNS = ["USER_ID","EMPLOYEE_NAME","TOTAL_EMPLOYEES","ASSIGNED_QUALIFICATION","COMPLETED_QUALIFICATION","IN_DUE_QUALIFICATION","PAST_DUE_QUALIFICATION","IN_COMPLETE_QUALIFICATION"];
...
export const GET_PAST_DUE_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","DUE_DATE"];
export const GET_COMING_DUE_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","DUE_DATE"];