...
namespace ReportBuilderAPI.DatabaseManager
{
    ...
    public class Employee
    {
        ...
        {
            return "SELECT Id FROM dbo.[USER] WHERE Email='" + email + "'";
        }
        ...
        {
            return "SELECT uc.companyId FROM dbo.[USER] u JOIN dbo.UserCompany uc on uc.UserId=u.Id WHERE Email='" + email + "'";
        }
    }
}
