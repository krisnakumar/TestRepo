    ...
    public static class ParameterHelper
    {
        ...
        public static Dictionary<string, string> Getparameters(QueryBuilderRequest queryRequest)
        {
            ...
            try
            {
                ...
                supervisorId = queryRequest.Fields.Where(x => x.Name.ToUpper() == Constants.SUPERVISOR_ID || x.Name.ToUpper() == Constants.SUPERVISOR_SUB || x.Name.ToUpper() == Constants.SUPERVISOR_USER || x.Name.ToUpper() == Constants.COMPANY_USER_ID || x.Name.ToUpper() == Constants.NOT_SUPERVISORID || x.Name.ToUpper() == Constants.USERID).Select(x => x.Value).FirstOrDefault();
