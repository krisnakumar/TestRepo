...
describe("WorkBookDashBoard component", () => {
  test("check renders", () => {
    const wrapper = shallow(<WorkBookDashBoard modal={false} WorkBooksDashBoard={[]} />);
  ...
  it('should call employeeFormatter', () => {
    ...
    const wrapper = shallow(<WorkBookDashBoard />);
  ...
  it('should call updateMyEmployeesArray', () => {
    const wrapper = shallow(<WorkBookDashBoard myEmployeesArray= {[]}/>);
    const spy = jest.spyOn(wrapper.instance(), 'updateMyEmployeesArray');
    //update the instance with the new spy
    wrapper.instance().updateMyEmployeesArray([], "Test Modal");
    //invoke createRows
    expect(spy).toBeCalled();
  });

  it('should call popMyEmployeesArray', () => {
    const wrapper = shallow(<WorkBookDashBoard />);
    const spy = jest.spyOn(wrapper.instance(), 'popMyEmployeesArray');
    //update the instance with the new spy
    wrapper.instance().popMyEmployeesArray();
    //invoke createRows
    expect(spy).toBeCalled();
  });
  ...
  it('should call componentDidMount', () => {
    ...
    //update the instance with the new spy
    wrapper.instance().componentDidMount({ employee: [], modal: true });
  ...
  it('should call async getEmployees', () => {
    const wrapper = shallow(<WorkBookDashBoard />);
    const spy = jest.spyOn(wrapper.instance(), 'getEmployees');
    //update the instance with the new spy
    wrapper.instance().getEmployees(1, 1, "");
    //invoke getEmployees
    expect(spy).toBeCalled();
  });
  ...
  it('should call async getMyEmployees', () => {
    ...
    //update the instance with the new spy
    wrapper.instance().getMyEmployees(1);
    //invoke getMyEmployees
    expect(spy).toBeCalled();
  });
  ...
  it('should call updateSelectedData', () => {
    ...
    const wrapper = shallow(<WorkBookDashBoard updateState={updateStateFn} updateSelectedData={updateSelectedDataFn} modal={false} filterOptionsRoles={[]} title={""} />);

    const spy = jest.spyOn(wrapper.instance(), 'updateSelectedData');
    //update the instance with the new spy
    wrapper.instance().updateSelectedData(updateSelectedDataFn);
    //invoke render
    expect(spy).toBeCalled();
  });

  it('should call handleRoleDelete', () => {
    const wrapper = shallow(<WorkBookDashBoard modal={false} filteredRoles={[]} title={""} />);
  ...
  it('should call customCell', () => {
    const wrapper = shallow(<WorkBookDashBoard modal={false} employee={[]} />);
