...
export const GET_COMPANY_QUALIFICATION_COLUMNS = ["LOCK_OUT_COUNT", "SUSPENDED_QUALIFICATION", "DISQUALIFIED_QUALIFICATION", "COMPANY_NAME", "COMPANY_ID", "ASSIGNED_COMPANY_QUALIFICATION", "COMPLETED_COMPANY_QUALIFICATION", "IN_COMPLETE_COMPANY_QUALIFICATION", "PAST_DUE_COMPANY_QUALIFICATION", "IN_DUE_COMPANY_QUALIFICATION", "TOTAL_COMPANY_EMPLOYEES"];
...
export const GET_EMPLOYEE_QUALIFICATION_COLUMNS = ["LOCK_OUT_COUNT", "SUSPENDED_QUALIFICATION", "DISQUALIFIED_QUALIFICATION", "USER_ID", "ROLE", "COMPANY_ID","EMPLOYEE_NAME","TOTAL_EMPLOYEES","ASSIGNED_QUALIFICATION","COMPLETED_QUALIFICATION","IN_DUE_QUALIFICATION","PAST_DUE_QUALIFICATION","IN_COMPLETE_QUALIFICATION"];
export const GET_ASSIGNED_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","ASSIGNED_DATE", "REASON"];
export const GET_COMPLETED_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","COURSE_EXPIRATION_DATE", "REASON"];
export const GET_IN_COMPLETED_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","ASSIGNED_DATE", "REASON"];
export const GET_PAST_DUE_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","COURSE_EXPIRATION_DATE", "REASON"];
export const GET_COMING_DUE_QUALIFICATION_COLUMNS = ["TASK_CODE","TASK_NAME","EMPLOYEE_NAME","COURSE_EXPIRATION_DATE", "REASON"];
