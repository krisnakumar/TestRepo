...
class OQDashboardExport extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            hasExcelData && <ExcelFile element={
                <div className="export-menu-right">
                    ...
                    } filename={"Industrial Training Services, Inc. Contractor OQ Dashboard " + date} fileExtension="xlsx">
