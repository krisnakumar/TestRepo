...
import FiltersModal from '../FilterModal.jsx';
...
describe("FiltersModal component", () => {
  test("check renders", () => {
    const wrapper = shallow(<FiltersModal modal={false} filterOptionsRoles={[]} title={""} />);
  ...
  it('should call toggle', () => {
    ...
    const wrapper = shallow(<FiltersModal updateState={clickFn} modal={false} filterOptionsRoles={[]} title={""} />);
  ...
  it('should call handleInputChange', () => {
    ...
    //update the instance with the new spy
    wrapper.instance().handleInputChange(eveent);
    //invoke render
    expect(spy).toBeCalled();
  });
  ...
  it('should call passSelectedData', () => {
    ...
    const wrapper = shallow(<FiltersModal updateState={updateStateFn} updateSelectedData={updateSelectedDataFn} modal={false} filterOptionsRoles={[]} title={""} />);
