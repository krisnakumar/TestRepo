...
//        - Trying to get coming due workbook list for a user which does not have any. Hence, expecting empty response with success code
...
//{
//    [TestClass]
//    public class InDueWorkbooks
//    {
//        /// <summary> 
//        /// Test to get coming due workbooks list for a user
...
//        /// <summary> 
//        /// Test to get coming due workbooks list for a user
//        /// [Inputs]        userId is given, which does not have any coming due workbooks
//        /// [Expectations]  An empty response with success code
//        /// [Assertions]    Success response code as 200
//        ///                 An empty response
//        /// </summary>
//        [TestMethod]
//        public void GetDueWorkbookListForUnsubscribedUser()
//        {
//            Function function = new Function();
//            var APIRequest = RequestBuilder.PathParamsRequest("userId", "6");
//            var workbookResponse = function.GetInDueWorkbookDetails(APIRequest, null);
